...
/***/ "./poeticsoft-content-payment/block/ctacampus/block.json":
/*!***************************************************************!*\
  !*** ./poeticsoft-content-payment/block/ctacampus/block.json ***!
  \***************************************************************/
/***/ ((module) => {
...
/***/ "./src/block/ctacampus/editor.scss":
/*!*****************************************!*\
  !*** ./src/block/ctacampus/editor.scss ***!
  \*****************************************/
...
/***/ "./src/block/ctacampus/pageselector.js":
/*!*********************************************!*\
  !*** ./src/block/ctacampus/pageselector.js ***!
  \*********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var _buildHierarchy = function buildHierarchy(pagesList) {
  ...
  return children.flatMap(function (page) {
    ...
    var label = "".concat(prefix, " ").concat(page.title || '(Sin título)');
    return [{
      label: label,
      value: page.id
...
(() => {
/*!***************************************!*\
  !*** ./src/block/ctacampus/editor.js ***!
  \***************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _editor_scss__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./editor.scss */ "./src/block/ctacampus/editor.scss");
/* harmony import */ var uuid__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! uuid */ "./node_modules/uuid/dist/v4.js");
/* harmony import */ var _pageselector__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./pageselector */ "./src/block/ctacampus/pageselector.js");
/* harmony import */ var blocks_ctacampus_block_json__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! blocks/ctacampus/block.json */ "./poeticsoft-content-payment/block/ctacampus/block.json");
...
var Edit = function Edit(props) {
  ...
  var blockId = attributes.blockId,
    ...
    targetText = attributes.targetText,
    discount = attributes.discount;
  var blockProps = useBlockProps();
  var _useState = useState(null),
    _useState2 = _slicedToArray(_useState, 2),
    pagesList = _useState2[0],
    setPagesList = _useState2[1];
  var _useState3 = useState(false),
    _useState4 = _slicedToArray(_useState3, 2),
    editingContents = _useState4[0],
    setEditingContents = _useState4[1];
  useEffect(function () {
    apiFetch({
      path: '/poeticsoft/contentpayment/campus/pages'
    }).then(setPagesList);
  }, []);
  useEffect(function () {
    if (!blockId) {
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(InspectorControls, null, /*#__PURE__*/React.createElement(PanelBody, {
    ...
    onClick: function onClick() {
      return setEditingContents(true);
    }
  }, "Text Contents")))), /*#__PURE__*/React.createElement("div", blockProps, targetId && pagesList ? /*#__PURE__*/React.createElement("div", {
    className: "\r block-editor-block-list__block \r wp-block wp-block-buttons \r block-editor-block-list__layout \r is-layout-flex wp-block-buttons-is-layout-flex\r "
  }, /*#__PURE__*/React.createElement("div", {
    className: "\r block-editor-block-list__block wp-block \r wp-block-button\r "
  }, /*#__PURE__*/React.createElement("div", {
    className: "\r block-editor-rich-text__editable \r wp-block-button__link \r wp-element-button \r rich-text\r "
  }, buttonText || pagesList.find(function (p) {
    return p.id == targetId;
  }).title))) : /*#__PURE__*/React.createElement("div", {
    className: "NoTree"
  }, "".concat(buttonText || 'Selecciona Página en Campus')), editingContents && /*#__PURE__*/React.createElement(Modal, {
    title: "CTA Content",
    className: "CTAEditTexts",
    onRequestClose: function onRequestClose() {
      return setEditingContents(false);
    }
  }, /*#__PURE__*/React.createElement(TextControl, {
    label: "Texto bot\xF3n",
    value: buttonText,
    onChange: function onChange(value) {
      return setAttributes({
        buttonText: value
    ...
    className: "EditContentLabel"
  }, "Texto target"), /*#__PURE__*/React.createElement(RichText, {
...
registerBlockType(blocks_ctacampus_block_json__WEBPACK_IMPORTED_MODULE_3__.name, {
  edit: Edit,
  save: Save
});
})();
