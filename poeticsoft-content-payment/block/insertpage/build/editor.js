...
/***/ "./poeticsoft-content-payment/block/insertpage/block.json":
/*!****************************************************************!*\
  !*** ./poeticsoft-content-payment/block/insertpage/block.json ***!
  \****************************************************************/
/***/ ((module) => {
...
/***/ "./src/block/insertpage/editor.scss":
/*!******************************************!*\
  !*** ./src/block/insertpage/editor.scss ***!
  \******************************************/
...
/***/ "./src/block/insertpage/pageselector.js":
/*!**********************************************!*\
  !*** ./src/block/insertpage/pageselector.js ***!
  \**********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var PageSelector = function PageSelector(_ref) {
  var thisPageId = _ref.thisPageId,
  ...
  var refreshPagesList = function refreshPagesList() {
    dispatch('core').invalidateResolution('getEntityRecords', ['postType', 'page', {
      status: 'publish',
      per_page: -1
    }]);
  ...
  var _allowedPage = function allowedPage(pageid) {
    if (pageid == thisPageId) {
      return false;
    } // Misma página, no permitido

    var page = pagesList.find(function (p) {
      return p.id == pageid;
    });
    var blocks = parse(page.content.raw);
    var blocksinsertpage = blocks.filter(function (b) {
      return b.name == 'poeticsoft/insertpage';
    });
    if (!blocksinsertpage.length) {
      return true;
    } // Pagina sin inserts, permitido

    var blocksinsertthispage = blocksinsertpage.filter(function (b) {
      return b.attributes.pageid == thisPageId;
    });
    if (blocksinsertthispage.length > 0) {
      return false;
    } // Pagina con inserts de la misma página, no permitido

    return blocksinsertpage.reduce(function (result, b) {
      result = result && _allowedPage(b.attributes.pageid);
      return result;
    }, true);
  };
  var options = useMemo(function () {
    ...
    var allowedpages = pagesList.filter(function (p) {
      return _allowedPage(p.id);
    }).sort(function (a, b) {
    ...
    return [{
      ...
      value: 0
    }].concat(_toConsumableArray(_buildHierarchy(allowedpages)));
  }, [pagesList]);
  return /*#__PURE__*/React.createElement(SelectControl, {
    label: /*#__PURE__*/React.createElement("div", {
      ...
      className: "Title"
    }, "Seleccionar P\xE1gina"), /*#__PURE__*/React.createElement(Button, {
      className: "Refresh",
      variant: "secondary",
...
/***/ "./src/block/insertpage/usefeatured.js":
/*!*********************************************!*\
  !*** ./src/block/insertpage/usefeatured.js ***!
  \*********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   useFeaturedImage: () => (/* binding */ useFeaturedImage)
/* harmony export */ });
var useSelect = wp.data.useSelect;
var useFeaturedImage = function useFeaturedImage(pageId) {
  var page = useSelect(function (select) {
    return pageId ? select('core').getEntityRecord('postType', 'page', pageId) : null;
  }, [pageId]);
  var media = useSelect(function (select) {
    return page && page.featured_media ? select('core').getMedia(page.featured_media) : null;
  }, [page]);
  if (!page) return {
    loading: true,
    url: null,
...
(() => {
/*!****************************************!*\
  !*** ./src/block/insertpage/editor.js ***!
  \****************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var uuid__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! uuid */ "./node_modules/uuid/dist/v4.js");
/* harmony import */ var _pageselector__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./pageselector */ "./src/block/insertpage/pageselector.js");
/* harmony import */ var _usefeatured__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./usefeatured */ "./src/block/insertpage/usefeatured.js");
/* harmony import */ var blocks_insertpage_block_json__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! blocks/insertpage/block.json */ "./poeticsoft-content-payment/block/insertpage/block.json");
/* harmony import */ var _editor_scss__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./editor.scss */ "./src/block/insertpage/editor.scss");
...
var Edit = function Edit(props) {
  ...
  var thisPageTitle = useSelect(function (select) {
    return select('core/editor').getEditedPostAttribute('title');
  }, []);
  var page = useSelect(function (select) {
    return select('core').getEntityRecord('postType', 'page', pageid);
  }, [pageid]);
  useEffect(function () {
    if (!blockId) {
      setAttributes({
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(InspectorControls, null, /*#__PURE__*/React.createElement(PanelBody, {
    ...
    initialOpen: true
  }, /*#__PURE__*/React.createElement(_pageselector__WEBPACK_IMPORTED_MODULE_1__.PageSelector, {
  ...
  }))), /*#__PURE__*/React.createElement("div", blockProps, !pageid && /*#__PURE__*/React.createElement("div", {
    className: "NoPage"
  }, "Selecciona p\xE1gina"), !showthumb && !showtitle && !showexcerpt && !showcontent && /*#__PURE__*/React.createElement("div", {
    className: "NoContents"
  }, "No contents"), page && showthumb && !featured.loading && featured.url && /*#__PURE__*/React.createElement("div", {
    className: "Image"
  }, /*#__PURE__*/React.createElement("img", {
    src: featured.url,
    alt: featured.alt
  })), page && showtitle && /*#__PURE__*/React.createElement("h2", {
    className: "Title"
  }, page.title.rendered), page && showexcerpt && /*#__PURE__*/React.createElement("div", {
    className: "Excerpt",
    dangerouslySetInnerHTML: {
      __html: page.excerpt.rendered
    }
  }), page && showcontent && /*#__PURE__*/React.createElement("div", {
    className: "Content",
    dangerouslySetInnerHTML: {
...
registerBlockType(blocks_insertpage_block_json__WEBPACK_IMPORTED_MODULE_3__.name, {
  edit: Edit,
  save: Save
});
})();
