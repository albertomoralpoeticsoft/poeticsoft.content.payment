...
/***/ "./poeticsoft-content-payment/block/pagecontext/block.json":
/*!*****************************************************************!*\
  !*** ./poeticsoft-content-payment/block/pagecontext/block.json ***!
  \*****************************************************************/
/***/ ((module) => {

module.exports = /*#__PURE__*/JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":2,"name":"poeticsoft/pagecontext","title":"Page context","category":"poeticsoft","icon":"media-archive","description":"Page context","keywords":[],"textdomain":"poeticsoft","version":"1.0.0","supports":{"align":["left","center","right"],"anchor":false,"customClassName":true,"className":true,"html":false,"__experimentalBorder":{"color":true,"radius":true,"style":true,"width":true},"border":{"color":true,"radius":true,"style":true,"width":true},"spacing":{"margin":true,"padding":true},"dimensions":{"minHeight":true,"width":true}},"attributes":{"blockId":{"type":"string","default":""},"refClientId":{"type":"string","default":""},"headingType":{"type":"string","default":"h3"},"idVisible":{"type":"boolean","default":true}},"editorScript":"file:./build/editor.js","editorStyle":"file:./build/editor.css","viewScript":"file:./build/view.js","viewStyle":"file:./build/view.css","render":"file:./render.php"}');
...
/***/ "./src/block/pagecontext/editor.scss":
/*!*******************************************!*\
  !*** ./src/block/pagecontext/editor.scss ***!
  \*******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
(() => {
/*!*****************************************!*\
  !*** ./src/block/pagecontext/editor.js ***!
  \*****************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _editor_scss__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./editor.scss */ "./src/block/pagecontext/editor.scss");
/* harmony import */ var uuid__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! uuid */ "./node_modules/uuid/dist/v4.js");
/* harmony import */ var blockscommon_elementselector__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! blockscommon/elementselector */ "./src/block/common/elementselector.js");
/* harmony import */ var blocks_pagecontext_block_json__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! blocks/pagecontext/block.json */ "./poeticsoft-content-payment/block/pagecontext/block.json");
...
var Edit = function Edit(props) {
  ...
  var selectHeadingType = function selectHeadingType(value) {
    setAttributes({
      headingType: value
    });
  };
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(InspectorControls, null, /*#__PURE__*/React.createElement(PanelBody, {
    ...
    initialOpen: true
  }, /*#__PURE__*/React.createElement(blockscommon_elementselector__WEBPACK_IMPORTED_MODULE_2__.HeadingSelector, {
    value: headingType,
    onChange: selectHeadingType
  }))), /*#__PURE__*/React.createElement("div", blockProps, hs[headingType]('Contexto de página')));
};
var Save = function Save() {
  return null;
};
registerBlockType(blocks_pagecontext_block_json__WEBPACK_IMPORTED_MODULE_3__.name, {
  edit: Edit,
  save: Save
});
})();
