...
/* harmony import */ var _ops__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./ops */ "./src/ui/admin/calendar/js/ops.js");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (function ($) {
  ...
  if ($calendarwrapper.length) {
    ...
    var calendarelm = $calendarwrapper[0];
    var calendar = new _fullcalendar_core__WEBPACK_IMPORTED_MODULE_0__.Calendar(calendarelm, {
      ...
      customButtons: {
        resyncbutton: {
          text: 'Resync',
          click: _ops__WEBPACK_IMPORTED_MODULE_6__.resync
        }
      },
      defaultAllDay: true,
      ...
      eventOverlap: true,
      editable: true,
      eventDataTransform: _ops__WEBPACK_IMPORTED_MODULE_6__.receivedtransform,
      validRange: _ops__WEBPACK_IMPORTED_MODULE_6__.validrange,
      events: _ops__WEBPACK_IMPORTED_MODULE_6__.fetchCampusEvents,
      select: _ops__WEBPACK_IMPORTED_MODULE_6__.onSelectCreateEvent,
      eventDrop: _ops__WEBPACK_IMPORTED_MODULE_6__.onEventUpdate,
      eventResize: _ops__WEBPACK_IMPORTED_MODULE_6__.onEventUpdate,
      eventClick: _ops__WEBPACK_IMPORTED_MODULE_6__.onEventDelete
    });
    calendar.render();
  }
});
...
/***/ "./src/ui/admin/calendar/js/ops.js":
/*!*****************************************!*\
  !*** ./src/ui/admin/calendar/js/ops.js ***!
  \*****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   fetchCampusEvents: () => (/* binding */ fetchCampusEvents),
/* harmony export */   onEventDelete: () => (/* binding */ onEventDelete),
/* harmony export */   onEventUpdate: () => (/* binding */ onEventUpdate),
/* harmony export */   onSelectCreateEvent: () => (/* binding */ onSelectCreateEvent),
...
var validrange = function validrange(nowDate) {
  return {
    start: nowDate
  };
};
var fetchCampusEvents = function fetchCampusEvents(fetchInfo, successCallback, failureCallback) {
  (0,uiutils_api__WEBPACK_IMPORTED_MODULE_0__.apifetch)('campus/calendar/events/get').then(function (res) {
    return res.json();
...
var onSelectCreateEvent = function onSelectCreateEvent(info) {
  var title = prompt('Título del evento');
  if (!title) {
    calendar.unselect();
    return;
  }
  (0,uiutils_api__WEBPACK_IMPORTED_MODULE_0__.apifetch)('campus/calendar/events/create', {
    method: 'POST',
    body: {
      title: title,
...
var onEventUpdate = function onEventUpdate(info) {
  (0,uiutils_api__WEBPACK_IMPORTED_MODULE_0__.apifetch)('campus/calendar/events/update', {
    method: 'POST',
    body: {
      id: info.event.id,
...
var onEventDelete = function onEventDelete(info) {
  // if (!confirm('¿Eliminar este evento?')) return;

  (0,uiutils_api__WEBPACK_IMPORTED_MODULE_0__.apifetch)('campus/calendar/events/delete', {
    method: 'POST',
    body: {
      id: info.event.id
    }
...
var apifetch = function apifetch(url, options) {
  var callnonce = poeticsoft_content_payment_api.nonce;
  var callurl = '/wp-json/poeticsoft/contentpayment/' + url;
  var calloptions = {
    headers: {
  ...
  return fetch(callurl, calloptions);
};
