...
/* harmony export */ });
/* harmony import */ var _fullcalendar_core_index_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @fullcalendar/core/index.js */ "./node_modules/@fullcalendar/core/index.js");
/* harmony import */ var _fullcalendar_daygrid_internal_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @fullcalendar/daygrid/internal.js */ "./node_modules/@fullcalendar/daygrid/internal.js");
...
/* harmony import */ var _fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @fullcalendar/core/preact.js */ "./node_modules/preact/dist/preact.module.js");





class SingleMonth extends _fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_2__.bc {
    constructor() {
        super(...arguments);
        this.buildDayTableModel = (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_2__.z)(_fullcalendar_daygrid_internal_js__WEBPACK_IMPORTED_MODULE_1__.buildDayTableModel);
        this.slicer = new _fullcalendar_daygrid_internal_js__WEBPACK_IMPORTED_MODULE_1__.DayTableSlicer();
        this.state = {
            labelId: (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_2__.a3)(),
        };
    }
    render() {
        ...
        return ((0,_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_3__.createElement)("div", { ref: props.elRef, "data-date": props.isoDateStr, className: "fc-multimonth-month", style: { width: props.width }, role: "grid", "aria-labelledby": state.labelId },
            (0,_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_3__.createElement)("div", { className: "fc-multimonth-header", style: { marginBottom: rowHeight }, role: "presentation" },
                (0,_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_3__.createElement)("div", { className: "fc-multimonth-title", id: state.labelId }, context.dateEnv.format(props.dateProfile.currentRange.start, props.titleFormat)),
                (0,_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_3__.createElement)("table", { className: [
                        'fc-multimonth-header-table',
                        context.theme.getClass('table'),
                    ].join(' '), role: "presentation" },
                    (0,_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_3__.createElement)("thead", { role: "rowgroup" },
                        (0,_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_3__.createElement)(_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_2__.bI, { dateProfile: props.dateProfile, dates: dayTableModel.headerDates, datesRepDistinctDays: false })))),
            (0,_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_3__.createElement)("div", { className: [
                ...
                (0,_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_3__.createElement)("table", { className: [
                    ...
                    (0,_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_3__.createElement)("tbody", { role: "rowgroup" },
                        (0,_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_3__.createElement)(_fullcalendar_daygrid_internal_js__WEBPACK_IMPORTED_MODULE_1__.TableRows, Object.assign({}, slicedProps, { dateProfile: dateProfile, cells: dayTableModel.cells, eventSelection: props.eventSelection, dayMaxEvents: !forPrint, dayMaxEventRows: !forPrint, showWeekNumbers: options.weekNumbers, clientWidth: props.clientWidth, clientHeight: props.clientHeight, forPrint: forPrint })))))));
    }
}

class MultiMonthView extends _fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_2__.bc {
    constructor() {
        super(...arguments);
        this.splitDateProfileByMonth = (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_2__.z)(splitDateProfileByMonth);
        this.buildMonthFormat = (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_2__.z)(buildMonthFormat);
        this.scrollElRef = (0,_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_3__.createRef)();
        this.firstMonthElRef = (0,_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_3__.createRef)();
        this.needsScrollReset = false;
    ...
    render() {
        ...
        return ((0,_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_3__.createElement)(_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_2__.cq, { elRef: this.scrollElRef, elClasses: rootClassNames, viewSpec: context.viewSpec }, monthDateProfiles.map((monthDateProfile, i) => {
            const monthStr = (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_2__.bv)(monthDateProfile.currentRange.start);
            return ((0,_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_3__.createElement)(SingleMonth, Object.assign({}, props, { key: monthStr, isoDateStr: monthStr, elRef: i === 0 ? this.firstMonthElRef : undefined, titleFormat: monthTitleFormat, dateProfile: monthDateProfile, width: monthWidthPct, tableWidth: monthTableWidth, clientWidth: clientWidth, clientHeight: clientHeight })));
        })));
    }
    componentDidMount() {
        this.updateSize();
    ...
    componentDidUpdate(prevProps) {
        if (!(0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_2__.E)(prevProps, this.props)) { // an external change?
    ...
    flushScrollReset() {
        if (this.needsScrollReset &&
            ...
            const scrollEl = this.scrollElRef.current;
            const monthEl = scrollEl.querySelector(`[data-date="${(0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_2__.bv)(currentDate)}"]`);
...
// date profile
// -------------------------------------------------------------------------------------------------
const oneMonthDuration = (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_2__.d)(1, 'month');
function splitDateProfileByMonth(dateProfileGenerator, dateProfile, dateEnv, fixedWeekCount, showNonCurrentDates) {
    ...
    while (monthStart.valueOf() < end.valueOf()) {
        ...
        const activeRange = dateProfile.activeRange ?
            (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_2__.o)(dateProfile.activeRange, showNonCurrentDates ? renderRange : currentRange) :
            null;
...
// date formatting
// -------------------------------------------------------------------------------------------------
const YEAR_MONTH_FORMATTER = (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_2__.x)({ year: 'numeric', month: 'long' });
const YEAR_FORMATTER = (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_2__.x)({ month: 'long' });
...
const OPTION_REFINERS = {
    multiMonthTitleFormat: _fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_2__.x,
...
(0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_2__.ct)(css_248z);
...
/* harmony export */ });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react-dom */ "react");
...
class FullCalendar extends react__WEBPACK_IMPORTED_MODULE_0__.Component {
    ...
    componentDidMount() {
        ...
        this.calendar = new _fullcalendar_core__WEBPACK_IMPORTED_MODULE_1__.Calendar(this.elRef.current, Object.assign(Object.assign({}, this.props), { handleCustomRendering: this.handleCustomRendering }));
        this.calendar.render();
        // attaching with .on() will cause this to fire AFTER internal preact rendering did flushSync
        this.calendar.on('_beforeprint', () => {
            (0,react__WEBPACK_IMPORTED_MODULE_0__.flushSync)(() => {
        ...
        customRenderingStore.subscribe((customRenderingMap) => {
            ...
            syncRenderingByDefault ||
                ...
                : react__WEBPACK_IMPORTED_MODULE_0__.flushSync; // guaranteed sync rendering
            runFunc(() => {
...
class CustomRenderingComponent extends react__WEBPACK_IMPORTED_MODULE_0__.PureComponent {
    render() {
        ...
        const vnode = typeof generatorMeta === 'function' ?
            ...
            generatorMeta;
        return (0,react__WEBPACK_IMPORTED_MODULE_0__.createPortal)(vnode, customRendering.containerEl);
    }
}
// Util
// -------------------------------------------------------------------------------------------------
...
/***/ "./src/ui/admin/calendar/js/admin.js":
/*!*******************************************!*\
  !*** ./src/ui/admin/calendar/js/admin.js ***!
  \*******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/ui/admin/calendar/js/app.js":
/*!*****************************************!*\
  !*** ./src/ui/admin/calendar/js/app.js ***!
  \*****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */ });
/* harmony import */ var _fullcalendar_react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @fullcalendar/react */ "./node_modules/@fullcalendar/react/dist/index.js");
...
/* harmony import */ var _state__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./state */ "./src/ui/admin/calendar/js/state.js");
/* harmony import */ var _modal__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modal */ "./src/ui/admin/calendar/js/modal.js");
/* harmony import */ var _admin__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./admin */ "./src/ui/admin/calendar/js/admin.js");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (function () {
  var _useReducer = useReducer(_state__WEBPACK_IMPORTED_MODULE_5__.reducer, _state__WEBPACK_IMPORTED_MODULE_5__.initState),
    _useReducer2 = _slicedToArray(_useReducer, 2),
    state = _useReducer2[0],
    dispatch = _useReducer2[1];
  var refreshevents = function refreshevents() {
    apifetch('campus/calendar/events/get').then(function (response) {
      return response.json();
    }).then(function (events) {
      return dispatch({
        events: events,
        eventsbygroup: events.reduce(function (eventsbygroup, event) {
  ...
  return /*#__PURE__*/React.createElement("div", {
    className: ""
  }, /*#__PURE__*/React.createElement(_fullcalendar_react__WEBPACK_IMPORTED_MODULE_0__["default"], {
    plugins: [_fullcalendar_interaction__WEBPACK_IMPORTED_MODULE_1__["default"], _fullcalendar_daygrid__WEBPACK_IMPORTED_MODULE_3__["default"], _fullcalendar_timegrid__WEBPACK_IMPORTED_MODULE_4__["default"], _fullcalendar_multimonth__WEBPACK_IMPORTED_MODULE_2__["default"]],
    initialView: "multiMonthYear",
    aspectRatio: 1,
    headerToolbar: {
    ...
    customButtons: {
      resyncbutton: {
        text: 'Admin',
        click: _admin__WEBPACK_IMPORTED_MODULE_7__.admin
      }
    },
    editable: true,
    events: state.events
  }), /*#__PURE__*/React.createElement(_modal__WEBPACK_IMPORTED_MODULE_6__["default"], {
    state: state,
    dispatch: dispatch
  }));
});
...
/***/ "./src/ui/admin/calendar/js/calendar.js":
/*!**********************************************!*\
  !*** ./src/ui/admin/calendar/js/calendar.js ***!
  \**********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _app__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./app */ "./src/ui/admin/calendar/js/app.js");
var render = wp.element.render;

/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (function () {
  render(/*#__PURE__*/React.createElement(_app__WEBPACK_IMPORTED_MODULE_0__["default"], null), document.getElementById('CalendarWrapper'));
});

/***/ }),

/***/ "./src/ui/admin/calendar/js/modal.js":
/*!*******************************************!*\
  !*** ./src/ui/admin/calendar/js/modal.js ***!
  \*******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/ui/admin/calendar/js/state.js":
/*!*******************************************!*\
  !*** ./src/ui/admin/calendar/js/state.js ***!
  \*******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/ui/admin/calendar/main.scss":
/*!*****************************************!*\
  !*** ./src/ui/admin/calendar/main.scss ***!
  \*****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
"use strict";
/*!***************************************!*\
  !*** ./src/ui/admin/calendar/main.js ***!
  \***************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _main_scss__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./main.scss */ "./src/ui/admin/calendar/main.scss");
/* harmony import */ var _js_calendar__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./js/calendar */ "./src/ui/admin/calendar/js/calendar.js");
